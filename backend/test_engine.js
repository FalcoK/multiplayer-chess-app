...
// ------------------------------------------------------------------------
try {
  console.log("Testing chess engine initialization...");
  const fen = "rnbqkbnr/pppppppp/8/8/4p3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2"; // e4 played, White turn
  
  console.log("Evaluating board...");
  const score = evaluateBoard(new Chess(fen));
  console.log("Board score:", score);

  console.log("Testing getBestMove at Level 1...");
  const moveL1 = getBestMove(fen, 1);
  console.log("Level 1 move:", moveL1 ? moveL1.san : "None");

  console.log("Testing getBestMove at Level 2...");
  const moveL2 = getBestMove(fen, 2);
  console.log("Level 2 move:", moveL2 ? moveL2.san : "None");

  console.log("Testing getBestMove at Level 3...");
  const moveL3 = getBestMove(fen, 3);
  console.log("Level 3 move:", moveL3 ? moveL3.san : "None");

  console.log("✅ All levels executed successfully without errors!");
} catch (e) {
